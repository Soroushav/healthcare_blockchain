...
import { X, Upload, Wallet, Calendar, FileText } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input type="text" placeholder="e.g. Jane Doe" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" />
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <input type="text" placeholder="Passport / National ID" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" />
              </div>
              <div className="space-y-1">
                <label className="text-sm font-medium text-slate-700">Wallet Address</label>
                <div className="relative">
                  <Wallet className="absolute left-3 top-2.5 text-indigo-500" size={16} />
                  <input 
                    type="text" 
                    value="0x71C...9A23" 
                    readOnly 
                    className="w-full pl-10 pr-3 py-2 bg-indigo-50 border border-indigo-100 text-indigo-700 rounded-lg font-mono text-sm cursor-not-allowed" 
                  />
                </div>
                <p className="text-xs text-indigo-400 mt-1">Auto-filled from MetaMask</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                 ...
                 <input type="text" value="v1.4.2 (Latest)" disabled className="w-full px-3 py-2 bg-gray-50 border border-gray-200 text-gray-500 rounded-lg" />
              </div>
            ...
            {certType === 'vaccination' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-2">
                <div className="col-span-2 space-y-1">
                  ...
                  <input type="text" placeholder="e.g. Pfizer-BioNTech" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" />
                </div>
                <div className="space-y-1">
            ...
            {certType === 'test' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-2">
                ...
                <div className="col-span-2 space-y-1">
                  ...
                  <input type="text" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none" />
                </div>
                <div className="col-span-2 space-y-1">
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
          ...
          <button className="px-6 py-2 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all">
            Issue Certificate
          </button>
        </div>
